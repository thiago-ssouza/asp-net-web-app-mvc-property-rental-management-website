...
namespace ASPNetWebAppMvcPRMWebsite.Controllers
{
    public class PropertyManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PM_Id,PropertyManagerId,FirstName,LastName,Email,Phone,Password")] PropertyManager propertyManager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PM_Id,PropertyManagerId,FirstName,LastName,Email,Phone,Password")] PropertyManager propertyManager)
        {
            if (ModelState.IsValid)
            {
